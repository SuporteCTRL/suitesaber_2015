...
echo "&nbsp; &nbsp; Script: usuarios_prestamos_presentar.php </font>
	</div>";
...
echo "<a id=botoes  href=\"javascript: void(0)\" 
   onclick=\"window.open('/central/dataentry/imprimir_g.php?base=trans&cipar=trans.par&fgen=devolv|CT&encabezado=s&Expresion=".$arrHttp["usuario"]."',   'windowname1',  'width=350, height=700'); return false;\">&nbsp;Ticket de devolução</a>";
?>
