...
<br><br><br>
<?
echo "<center><h1>".$msgstr["bd"].": ".$arrHttp["base"]."</h1>";
echo "<br><h2>". $msgstr["maxmfn"].": ".$tag["MAXMFN"]."</h2></font>";
if ($tag["BD"]=="N")
...
echo "<h3><a href=\"fmt.php?Opcion=ver&base=$arrHttp[base]&cipar=$arrHttp[base].par&Mfn=1&ver=S&Formato=$arrHttp[base]&Diferido=N#\"> EXPLORAR>>></a></h3>";
?>
</div>
</div>
</center>
