...
function readData($readFrom, $removeHeader = true)
{
    ...
    if (preg_match("/swish/i", $readFrom)) {
        ...
        // transforma as entidades html em caracteres para n�o gerar erro no XSL transformation
...
function insertDefaultConnector( $exp, $connector = "and"){
    ...
    if ( substr($str,0,4) == '[MH]' ){
        $str = str_replace('EX ','EX+', $exp);        //n�o realizar replace por operador booleno quando a expressao usar prefixo de EXPLODE
    }
