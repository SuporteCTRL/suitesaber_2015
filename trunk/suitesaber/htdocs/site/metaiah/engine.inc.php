...
function GoSearch($target_node, $sourceListNode, $expression = ""){
    ...
    // cria um vetor de indice com os itens do n� sourceList
    ...
    for ($i = 0; $i < count($target_node->children); $i++){
            ...
            if ($form == 'advanced' & ! isset($selected_sources[$sourceName])){   // se fonte n�o esta selecionada

                // mesmo que a fonte n�o esteja habilitada executa search nos casos
                // onde o grupo $current_group = 'all' ou a fonte � �nica dentro do grupo
                continue;
                /*
            ...
            // n�o executa pesquisa nas fontes desabilitadas (available = no)
