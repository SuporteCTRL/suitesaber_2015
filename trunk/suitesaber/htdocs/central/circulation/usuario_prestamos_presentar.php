...
if ($cont=="S" and ($reservas_p==0 or $posicion_cola==1)){
	echo " <a href=usuario_prestamos_prestar.php?usuario=".$arrHttp["usuario"]."&inventario=".$arrHttp["inventory"]."&signatura=".$signatura."&reserva=$posicion_cola class=\"submit\"><dd><h4>".$msg_1.": </font>".$msgstr["inventory"].": ".$arrHttp["inventory"]."</h4></a>";
}
?>
</div></div>
