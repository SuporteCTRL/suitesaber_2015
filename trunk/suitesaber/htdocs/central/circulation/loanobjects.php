...
//    		return
    	...
    	x=Trim(document.forma1.dias_espera.value)
    	xItem+='|'+x
    	...
    	for (var c in RT){
    		...
    		switch (c){    			case "0":
				...
				case "5":
					...
					html+="<input type=radio name=unidad value=D"+Dias+"><?php echo $msgstr['dias']?>&nbsp;&nbsp;&nbsp;<input type=radio name=unidad value=H"+Horas+"><?php echo $msgstr['horas']?></td>"
					break;
				case "6":
    			...
    			case "10":
    				...
    				break
    			case "11":
    				html+="<input type=text name=dias_espera value=\""+cell[c]+"\"></td>"
    				break
				case "12":
					chk=""
            ...
            if (Trim(sel)!=""){
		    	...
		    	for (var c in cell){
		    		...
		    		switch (c){
						...
						case "5":
							unidad=""
							if (cell[c]=="D") unidad="<?php echo $msgstr['dias']?>"
							if (cell[c]=="H") unidad="<?php echo $msgstr['horas']?>"
							html+="<td>"+unidad+"</td>"
		    				break
						case "12":
							chk=""
