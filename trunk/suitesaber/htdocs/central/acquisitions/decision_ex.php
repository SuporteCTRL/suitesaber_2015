...
<div class="language">
		<a href=decision.php?encabezado=s&base=<?php echo $arrHttp["base"]."&sort=".$arrHttp["sort"].$see_all?> class="defaultButton">
	...
	<div class="breadcrumb">
		<h3><?php echo $msgstr["suggestions"].": ".$msgstr["decision"]?></h3>
	</div>
	<div class="actions">
